...
class __TwigTemplate_93d14a3c5145c274c704abbd664e0369 extends Template
{
    private $source;
    private $macros = [];
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    yield "      <ul";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["toolbar-menu"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    yield ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/stable9/templates/navigation/menu--toolbar.html.twig", "C:\\xampp\\htdocs\\f_acres_drupal11\\web\\core\\themes\\stable9\\templates\\navigation\\menu--toolbar.html.twig");
    }
